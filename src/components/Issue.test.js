...
it('renders', () => {
  const context = { router: {params: {org: 'twitter', repo: 'bootstrap'}} };
  const tree = shallow(
    <Issue
        number={27593}
