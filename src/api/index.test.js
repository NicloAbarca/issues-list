...
describe('getIssues', () => {
  it('builds the url', (done) => {
    axios.get = url => {
      expect(url).toEqual('https://api.github.com/repos/twitter/bootstrap/issues?per_page=25&page=123');
      done();
  ...
  it('builds the url with a default page', (done) => {
    axios.get = url => {
      expect(url).toEqual('https://api.github.com/repos/twitter/bootstrap/issues?per_page=25&page=1');
      done();
      return Promise.resolve({data: {}, headers: {}});
    }
    getIssues('foo', 'bar');
  ...
  it('parses successful response', (done) => {
    ...
    getIssues('twitter', 'bootstrap').then(issues => {
...
describe('getRepoDetails', () => {
  it('builds the url', (done) => {
    axios.get = url => {
      expect(url).toEqual('https://api.github.com/repos/twitter/bootstrap');
      done();
      return Promise.resolve({});
    }
  ...
  it('handles successful responses', (done) => {
    ...
    getRepoDetails('twitter', 'bootstrap').then(count => {
  ...
  it('handles error responses', (done) => {
    ...
    getRepoDetails('twitter', 'bootstrap')
      .then(fail)
      .catch(count => {
...
describe('getIssue', () => {
  ...
  it('builds the url', (done) => {
    axios.get = url => {
      expect(url).toEqual('https://api.github.com/repos/twitter/bootstrap/issues/123');
      done();
      return Promise.resolve({});
    }
  ...
  it('handles successful responses', (done) => {
    ...
    getIssue('twitter', 'bootstrap', 1234).then(data => {
  ...
  it('handles error responses', (done) => {
    ...
    getIssue('twitter', 'bootstrap', 1234)
      .then(fail)
      .catch(err => {
