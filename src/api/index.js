...
import page4 from '../fixtures/issues/page4';
...
if(USE_STATIC_DATA) {
  ...
  mock.onGet('https://api.github.com/repos/twitter/bootstrap/issues', { params: { per_page: '25', page: '1' }})
    .reply(200, page1);
  mock.onGet('https://api.github.com/repos/twitter/bootstrap/issues', { params: { per_page: '25', page: '2' }})
    .reply(200, page2);
  mock.onGet('https://api.github.com/repos/twitter/bootstrap/issues', { params: { per_page: '25', page: '3' }})
    .reply(200, page3);
  mock.onGet('https://api.github.com/repos/twitter/bootstrap/issues', { params: { per_page: '25', page: '4' }})
    .reply(200, page4);
...
export function getIssues(org, repo, page = 1) {
  const url = `https://api.github.com/repos/twitter/bootstrap/issues?per_page=25&page=${page}`;
...
export function getRepoDetails(org, repo) {
  const url = `https://api.github.com/repos/twitter/bootstrap`;
  return axios.get(url)
    .then(res => res.data)
...
export function getIssue(org, repo, number) {
  const url = `https://api.github.com/repos/twitter/bootstrap/issues/${number}`;
  return axios.get(url)
    .then(res => res.data)
    .catch(err => Promise.reject(err));
}
